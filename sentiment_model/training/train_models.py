...
if __name__ == '__main__':
    ...
    if options["models"] == "all":
        model_0, baseline_results = model_0_training()
        tf_model_1, model_1_results = model_1_training()
        tf_model_2, model_2_results = model_2_training()
        tf_model_3, model_3_results = model_3_training()
        tf_model_4, model_4_results = model_4_training()
        tf_model_5, model_5_results = model_5_training()
        tf_model_6, model_6_results = model_6_training()
        tf_model_7, model_7_results = model_7_training()
